...
//static plc_tag_p map_id_to_tag(tag_id tag_id);
...
//static int tag_ptr_to_tag_index(tag_id tag_id_ptr);
...
/* helper functions. */
static plc_tag_p lookup_tag(tag_id id);
static tag_id add_tag_lookup(plc_tag_p tag);
static int tag_id_inc(tag_id id);
...
//        if(tag_lookup_table[i]) {
//            pdebug(DEBUG_WARN,"Tag %p at index %d was not destroyed!",tag_lookup_table[i],i);
//        }
//    }
...
LIB_EXPORT int plc_tag_set_int64(tag_id id, int offset, int64_t ival)
{
...
LIB_EXPORT int plc_tag_set_int32(tag_id id, int offset, int32_t ival)
{
...
LIB_EXPORT int plc_tag_set_int16(tag_id id, int offset, int16_t ival)
{
...
LIB_EXPORT int plc_tag_set_int8(tag_id id, int offset, int8_t ival)
{
...
LIB_EXPORT int plc_tag_set_float64(tag_id id, int offset, double fval)
{
    int rc = PLCTAG_STATUS_OK;
    uint64_t val = 0;
    plc_tag_p tag = lookup_tag(id);
...
LIB_EXPORT int plc_tag_set_float32(tag_id id, int offset, float fval)
{
    int rc = PLCTAG_STATUS_OK;
    uint32_t val = 0;
    plc_tag_p tag = lookup_tag(id);
...
plc_tag_p lookup_tag(tag_id id)
{
    int index = 0;
    plc_tag_p tag = NULL;
...
//static inline int tag_ptr_to_tag_index(tag_id tag_id_ptr)
//{
...
tag_id add_tag_lookup(plc_tag_p tag)
{
    tag_id new_id = next_tag_id;
    int index = 0;
    int found = 0;
...
// */
//
//static plc_tag_p map_id_to_tag(tag_id tag_id_ptr)
//{
