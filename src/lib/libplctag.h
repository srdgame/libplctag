...
/* version 2.0.0 */
    ...
    #define PLCTAG_ERR_BAD_CONFIG (-1)
    #define PLCTAG_ERR_BAD_CONNECTION (-2)
    #define PLCTAG_ERR_BAD_DATA (-3)
    #define PLCTAG_ERR_BAD_DEVICE (-4)
    #define PLCTAG_ERR_BAD_GATEWAY (-5)
    #define PLCTAG_ERR_BAD_PARAM (-6)
    #define PLCTAG_ERR_BAD_REPLY (-7)
    #define PLCTAG_ERR_BAD_STATUS (-8)
    #define PLCTAG_ERR_CLOSE (-9)
    #define PLCTAG_ERR_CREATE (-10)
    #define PLCTAG_ERR_DUPLICATE (-11)
    #define PLCTAG_ERR_ENCODE (-12)
    #define PLCTAG_ERR_MUTEX_DESTROY (-13)
    #define PLCTAG_ERR_MUTEX_INIT (-14)
    #define PLCTAG_ERR_MUTEX_LOCK (-15)
    #define PLCTAG_ERR_MUTEX_UNLOCK (-16)
    #define PLCTAG_ERR_NOT_ALLOWED (-17)
    #define PLCTAG_ERR_NOT_FOUND (-18)
    #define PLCTAG_ERR_NOT_IMPLEMENTED (-19)
    #define PLCTAG_ERR_NO_DATA (-20)
    #define PLCTAG_ERR_NO_MATCH (-21)
    #define PLCTAG_ERR_NO_MEM (-22)
    #define PLCTAG_ERR_NO_RESOURCES (-23)
    #define PLCTAG_ERR_NULL_PTR (-24)
    #define PLCTAG_ERR_OPEN (-25)
    #define PLCTAG_ERR_OUT_OF_BOUNDS (-26)
    #define PLCTAG_ERR_READ (-27)
    #define PLCTAG_ERR_REMOTE_ERR (-28)
    #define PLCTAG_ERR_THREAD_CREATE (-29)
    #define PLCTAG_ERR_THREAD_JOIN (-30)
    #define PLCTAG_ERR_TIMEOUT (-31)
    #define PLCTAG_ERR_TOO_LARGE (-32)
    #define PLCTAG_ERR_TOO_SMALL (-33)
    #define PLCTAG_ERR_UNSUPPORTED (-34)
    #define PLCTAG_ERR_WINSOCK (-35)
    #define PLCTAG_ERR_WRITE (-36)
    ...
    LIB_EXPORT uint64_t plc_tag_get_uint64(tag_id tag, int offset);
    LIB_EXPORT int plc_tag_set_uint64(tag_id tag, int offset, uint64_t val);

    LIB_EXPORT int64_t plc_tag_get_int64(tag_id tag, int offset);
    LIB_EXPORT int plc_tag_set_int64(tag_id, int offset, int64_t val);
    ...
    LIB_EXPORT double plc_tag_get_float64(tag_id tag, int offset);
    LIB_EXPORT int plc_tag_set_float64(tag_id tag, int offset, double val);
